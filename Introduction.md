...
https://github.com/cmzuidema/r_onramp 

and have been forked from the [original repository](https://github.com/deohs/r_onramp).

You can download a copy or import the repository into RStudio.

- File ->  New Project -> Version Control -> Git
- Repository URL: https://github.com/cmzuidema/r_onramp.git
- (Create Project)
...
The RStudio Desktop application is available for free on from posit. Visit the [posit website](https://posit.co/download/rstudio-desktop/) to download and install:

1. [**_R_**](https://cran.rstudio.com/) 
2. [**_RStudio Desktop_**](https://posit.co/download/rstudio-desktop/)

Run the installers (usually by double-clicking on the installer's icon). Click through the installer's prompts accordingly. The defaults are usually fine.

You may remove the installers when you have confirmed that RStudio is installed correctly and launches without error.
...
In RStudio on posit Cloud you will also upload and download files using this tab.
